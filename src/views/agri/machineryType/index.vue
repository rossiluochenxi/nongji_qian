    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['agri:machineryType:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['agri:machineryType:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['agri:machineryType:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['agri:machineryType:export']"
        >导出</el-button>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getMachineryType(id).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除农机类型编号为"' + ids + '"的数据项？').then(function() {
        return delMachineryType(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('agri/machineryType/export', {
        ...this.queryParams
      }, `machineryType_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
